...
class ProductsController extends Controller
{
     ...
     *     tags={"Products Katalog"},
     *     summary="Show Product Katalog Details",
     *     description="Show Product Katalog Details",
     *     operationId="show",
     *     security={{"bearer":{}}},
     ...
     *     path="/api/products/{id}",
     *     tags={"Products"},
     *     summary="Update Product Katalog",
     *     description="Update Product Katalog",
     *     @OA\Parameter(name="id", description="id, eg; 1", required=true, in="path", @OA\Schema(type="integer")),
     *     @OA\RequestBody(
     *          @OA\JsonContent(
     *              type="object",
     ...
     *     path="/api/products/{id}",
     *     tags={"Products"},
     *     summary="Delete Product Katalog",
     *     description="Delete Product Katalog",
     *     operationId="destroy",
     *     security={{"bearer":{}}},
     *     @OA\Parameter(name="id", description="id, eg; 1", required=true, in="path", @OA\Schema(type="integer")),
