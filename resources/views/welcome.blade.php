        ...
        <div class="center mt-5">
            <div class="card m-5">
                <div class="card body">
                    ...
                    <h2 class="mt-3">Test for Back End Developer: Isam Samsul Arip</h2>
                    <div class="text-center">
                        <span class="badge badge-info">Using Laravel 9</span>
                    </div>
                    <hr>
                    <p>API Documentation for car product catalog and user authentication</p>
                    ...
                    <p class="text-center">
                        ...
                        <a href="https://github.com/isamsamsularip" target="_blank"
                            class="btn btn-info">
